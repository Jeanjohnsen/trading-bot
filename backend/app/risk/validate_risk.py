...
from app.domain.models import AppMode, MarketQuote, OpportunityCandidate, PositionSummary, ProposedSize, RiskDecision
...
class RiskEngine:
    def __init__(self, runtime_config: dict, live_enabled: bool, kill_switch_active: bool) -> None:
    ...
    def evaluate(
        ...
        new_total_exposure = current_total_exposure(state.open_positions) + opportunity.capital_at_risk
